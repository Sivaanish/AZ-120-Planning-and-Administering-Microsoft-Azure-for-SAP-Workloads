...
2. Login to az12001a-vm0 by using username **student** and password **Pa55w.rd1234**.

3. Open a new putty window type the ip of az12001a-vm1(192.168.0.5) click on connect.

4.Type username as **student** and password **Pa55w.rd1234**
